...
<head>
    ...
    <!-- CSS Assets -->
    <link rel="stylesheet" href="{{ asset('/') }}front/css/bootstrap-custom.min.css">
    <link href="https://fonts.googleapis.com/css?family=Exo+2:400%7CPoppins:300,400,500,600,700%7CRaleway:300,400,500,600,700,800" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('/') }}front/css/ionicons.min.css">
    <link rel="stylesheet" href="{{ asset('/') }}front/css/hamburgers-custom.min.css">
    <link rel="stylesheet" href="{{ asset('/') }}front/css/lity.min.css">
    <link rel="stylesheet" href="{{ asset('/') }}front/css/owl.carousel.min.css">
    <link rel="stylesheet" href="{{ asset('/') }}front/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="{{ asset('/') }}front/css/main.css">
    <link rel="stylesheet" href="{{ asset('/') }}front/css/colors/main-blue.css" id="color-scheme">
    <link rel="stylesheet" href="{{ asset('/') }}front/css/variants/snow.css">
...
<body>
    ...
    <header>
        ...
        <!-- Header Area (Home) -->
        <section class="header-area section-fixed-bg section-overlay-bg" id="header-area" style="background-image:url('{{ asset('/') }}front/img/header-area.jpg')">
            <div id="particles-js"></div>
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-12 col-lg-8 home-content text-center">
                        <h5 class="greet">Hello, my name is <b>Daniel</b></h5>
                        ...
                        <p class="description">I'm a Web Developer with extensive experience for over 3 years. My expertise is to create and design Websites, Apps, Mockups and many more...</p>
                        <a class="btn work" data-scroll href="#portfolio-area" role="button">My Work</a>
                        <a class="btn hire button-scheme" data-scroll href="#contact-area" role="button">Hire me</a>
                    </div>
                ...
                <div class="col-12">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-5">
                            <img class="img-fluid img-thumbnail about-img" src="img/about-img.jpg" alt="About Picture">
                        </div>
                        <div class="col-12 col-lg-7">
                            <div class="content-block">
                                <h2 class="about-title">About Me</h2>
                                <h6 class="about-role">I am a Full-Stack Web Developer</h6>
                                <p class="about-description">My name is <b>Daniel Smith</b>. I am a freelancer based in UK and i have been building noteworthy websites for years. For this time i've done all types of projects.</p>
                                <p class="about-description last">I help convert a vision and an idea into meaningful and useful products. Having a sharp eye for product evolution helps me prioritize tasks, iterate fast and deliver faster. If you're interested in working with me, don't
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        ...
                        <p class="section-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione!</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service">
                        ...
                        <div class="service-body">
                            ...
                            <p class="service-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem, facere voluptate. Quidem, facere voluptate.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service mb-lg-0">
                        ...
                        <div class="service-body">
                            <h6 class="service-title">Unique Design</h6>
                            <p class="service-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem, facere voluptate. Quidem, facere voluptate.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="shufflejs" id="shufflejs">
                        <div class="js-item col-6 col-lg-4" data-groups='["design"]'>
                            <div class="item-overlay">
                                <img class="img-fluid" alt="Item" src="https://evonexus.org/wp-content/uploads/2013/12/dummy-200x200.png">
                                <div class="overlay-content">
                                    <h6 class="overlay-title">Software box</h6>
                                    <div class="overlay-icons">
                                        <a class="popup-item" href="img/item-1.jpg" data-lity>
                        ...
                        <div class="js-item col-6 col-lg-4" data-groups='["photos"]'>
                            <div class="item-overlay">
                                ...
                                <div class="overlay-content">
                                    ...
                                    <div class="overlay-icons">
                                        <a class="popup-item" href="https://evonexus.org/wp-content/uploads/2013/12/dummy-200x200.png" data-lity>
                                        <i class="fa fa-eye"></i>
                                    </a>
                                        <a href="#0">
                                        <i class="fa fa-link"></i>
                ...
                <div class="owl-carousel owl-theme">
                    <div class="col-12 col-md-8 offset-md-2">
                        <div class="single-review text-center">
                            ...
                            <p class="client-review">Daniel did an excellent job, creative, addressing my request, and also providing his own graphic insight. Quick and professional. I would highly recommend, and also will use again!</p>
                ...
                <div class="col-12 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore, porro rem quod illo quam, eum alias id, repellendus magni, quas.</p>
                            <div class="media post-summary">
                                <a class="align-self-center" href="#0">
                              <img src="img/sidebar-avatar.jpg" alt="Author" class="img-fluid rounded-circle author-avatar">
                          </a>
    ...
    <section class="single-section contact-area silver-bg" id="contact-area">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-lg-7">
                    <form class="contact-form" id="contact-form" method="post" action="https://exill.tn/demo/flexi_html/template/php/contact.php">
                            ...
                            <li>
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="info-details">4155 Mann Island, Liverpool L3, United Kingdom.</span>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="info-details"><a href="tel:+441632967704">+44 1632 967704</a></span>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="info-details"><a href="mailto:daniel@example.com">daniel@example.com</a></span>
                                    </div>
                                </div>
                            </li>
                        </ul>
    ...
    <footer class="footer-area single-section">
        <div class="container">
            <div class="row main-footer">
                ...
                <div class="col-12 col-md-3">
                    <h2 class="brand-logo">Flexi</h2>
                    <p class="brand-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                </div>
            </div>
            <div class="row mini-footer">
                <div class="col-12">
                    ...
                    <p class="copyright-notice">Copyright © 2018 Flexi, all rights reserved. Developed by <a href="https://themeforest.net/user/exill" target="_blank">Exill</a>.</p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script src="{{ asset('/') }}front/js/jquery.nav.min.js"></script>
    <script src="{{ asset('/') }}front/js/polyfill.mindee7.js?features=Set,Array.from,Object.assign,Array.prototype.find,Array.prototype.includes"></script>
    ...
    <script src="{{ asset('/') }}front/js/variants/snow.js"></script>
